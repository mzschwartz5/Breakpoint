	  ...
	  layoutType(layoutType)
{
    ...
    D3D12_INPUT_ELEMENT_DESC vertexLayoutTemp[] =
    {
    ...
    gfxPsod.InputLayout.NumElements = _countof(vertexLayoutTemp);
    gfxPsod.InputLayout.pInputElementDescs = vertexLayoutTemp;
...
D3D12_GRAPHICS_PIPELINE_STATE_DESC& RenderPipeline::getPSOD() {
	return this->gfxPsod;
}
